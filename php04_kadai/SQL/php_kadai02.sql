...
--
-- テーブルの構造 `wd_user_table`
--

CREATE TABLE `wd_user_table` (
  `id` int(12) NOT NULL,
...
--
-- テーブルのデータのダンプ `wd_user_table`
--

INSERT INTO `wd_user_table` (`id`, `name`, `lid`, `lpw`, `kanri_flg`, `life_flg`) VALUES
(1, 'テスト１管理者', 'test1', '$2y$10$Gej/h76VExfv94uOOZGCFeOVKYLOFezLfuEpTnWbfVq1/XBA80WVe', 1, 0),
(2, 'テスト2一般', 'test2', '$2y$10$80mStFjdzPn3gADWyO4rP.wBvf78QgQL1uxjYj8NkE2W4Apcfw.Ym', 0, 0),
(3, 'テスト３', 'test3', '$2y$10$5MqpcXV6utG05eQeHV3BiepHpY9LSgTUYrPZZBINoEIUmDDJX927G', 0, 0);
...
(22, 'あいうえお', 'タイムコンストレインメソッド', 'あいうえお', '2023-01-07 13:51:06'),
(24, 'テスト', 'Cフェーズ', 'テスト', '2023-01-12 14:42:25'),
(26, 'test2', '男フォルダに入れ,タイムコンストレインメソッド,Cフェーズ,恋愛遍歴の話を引き出せ', 'test2', '2023-01-12 19:45:25');
...
--
-- テーブルのインデックス `wd_user_table`
--
ALTER TABLE `wd_user_table`
  ADD PRIMARY KEY (`id`);
...
--
-- テーブルの AUTO_INCREMENT `wd_user_table`
--
ALTER TABLE `wd_user_table`
...
--
ALTER TABLE `words_and_deeds_table`
  MODIFY `wd_id` int(12) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
COMMIT;
