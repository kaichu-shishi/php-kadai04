...
//1.  DB接続します（funcs.phpで関数化したものを用いる）
$pdo = db_conn();
...
<head>
    ...
    <title>ザ・ゲーム・ライオンキング（ログイン中）</title>
        ...
        <nav class="page00__global-nav">
            <div class="page00__global-nav-inner g-nav-inner">
                <ul class="page00__global-nav-login-logout">
                    <li class="page00__global-nav-login"><span>ログイン</span></li>
                    <li class="page00__global-nav-logout"><a href="logout.php" onClick="if( !confirm('ログアウトしますか？') ) { return false; }">ログアウト</a></li>
                </ul>
